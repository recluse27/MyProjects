...
void Human::setData()
{
	...
	cin >> Name;
	cout << "Type your surname, please" << endl;
	cin >> Surname;
}
...
void Ticket::setData()
{
	do
	{
		cout << "Type the day of departure, please" << endl;
		cin >> day;
	} 
	while (day > 31 || day <= 0);
	do
	{
		cout << "Type the month, please (numbers)" << endl;
		cin >> month;
	} 
